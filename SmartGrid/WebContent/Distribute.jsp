...
<li><a href="Service.jsp">Management Service</a></li>
       <li><a href="Distribute.jsp"  class="active">Distribution Service</a></li>
        <li><a href="UserService.jsp">User Service</a></li>
...
<div id="wrapper">
 ...
 <center><h1>Welcome to Distribution Service </h1><br><br></center>
                                 <center>
